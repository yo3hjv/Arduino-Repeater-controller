/*
   ...
   -NEW in 8.2.1: Beacon 1 timer is resetting after each QSO; if no QSO, the Beacon 1 is transmitted at fixed    defined intervals
...
void CdetRepeat ()   
                ...
                //Serial.println(cDet);
                              if (cDet != lastcDet) {                 // if the state has changed                                                                    
                                   ...
                                   previousMillis = millis();            // Reset Beacon 1 timer at each QSO
                                                     }
