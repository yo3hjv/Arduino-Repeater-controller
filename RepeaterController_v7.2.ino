/*
   ...
   In this version:
      ...
      -Introducing the option to use analog reading of RSSI instead of Carrier Detect
...
int CarDetPin = 10;                // Carrier Detect Logic pin
...
void setup () {
          ...
          //  Serial.begin(9600);              // for debugging
               ...
               pinMode(CarDetPin, INPUT) ;   //  Carrier Detect on pin 10 with transistor, tied up with 10 kOhm.
